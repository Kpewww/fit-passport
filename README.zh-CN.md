...
| **徽章(Badges)** | 四条四级赛道(青铜 → 白银 → 黄金 → **钛**)—— 衣橱、合身记录、工坊、参谋 —— 外加稀有封顶徽章(钻石 / 黑曜石)和特殊荣誉(紫水晶 / 玉 / 琥珀)。钛取代了铂金,因为铂金的浅灰几乎无法与低两级的白银区分。全站每一枚徽章都是**立体铸造勋章**:静止时就以一定角度站立,让滚花边缘和厚度可见;单一方向打光(穹顶、明暗界线、边缘光、下沉底面、浮雕纹样);随光标转动;点击进入 inspect 舞台,用 WebGL 挤出它真实的轮廓。**没有扁平版本。** |
