...
// /ask — the community's utility loop (ecosystem step 2).
//
  ...
  return (
    <main className="flex-1">
      <div className="mx-auto max-w-3xl px-6 py-12">
        <h1 className="font-serif text-4xl text-ink">Ask the community</h1>
        <p className="mt-2 max-w-xl text-ink-soft">
          Answers here come with receipts. People can attach a garment they
          actually own — brand, size, how well it fits, and the build it fits — so
        ...
        <Card className="mt-8 bg-neutral-50">
          <h2 className="text-sm font-semibold text-ink">What makes an answer good here</h2>
